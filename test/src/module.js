    ...
    describe('Module', function() {
        ...
        describe('static getter events', function() {
            ...
            it('should return the list of events', function() {
                should(Module.events).be.deepEqual(eventsJson.module);
            });
        ...
        describe('static getter status', function() {
            ...
            it('should return the list of status', function() {
                should(Module.status).be.deepEqual(statusJson.module);
            });

            it('should not return the list of status on Class instance',
                function() {
                    should(testModule.status).not.be.deepEqual(statusJson.module);
                });
        ...
        describe('constructor()', function() {
            ...
            describe('with illegal argument', function() {
                ...
                it(
                    'should throw an error with an empty String (\'\') argument',
                    function() {
                        should(function() {
                            new Module('');
                        }).throw(errors.ERR_MOD_001);
            ...
            describe('with a string argument', function() {
                ...
                it('should have a status', function() {
                    should(testModule.status).be.exactly(Module
                        .status.CREATED);
                });
                ...
                describe('if another argument options', function() {
                    ...
                    it(
                        ...
                        function() {
                            should(testModule.options.timeout)
                                .be.exactly(
                                    1000);
                        });
            ...
            describe('with the package.json object (light)', function() {
                ...
                it('should have a version', function() {
                    should(testModule.version).be.exactly(
                        '1.0.0');
                });
            ...
            describe('with the package.json object (full)', function() {
                ...
                it('should have appropriate dependencies',
                    function() {
                        should(testModule.dependencies).be.an.Array();
                        should(testModule.dependencies).have.length(
                            2);
                    });
                ...
                describe('if another argument options', function() {
                    ...
                    it(
                        'should have corresponding options',
                        function() {
                            should(testModule.options.db_url)
                                .be.exactly(
                                    'localhost');
                            should(testModule.options.db_port)
                                .be.exactly(
                                    8080);
                            should(testModule.options.timeout)
                                .be.exactly(
        ...
        describe('setter dependencies', function() {
            ...
            describe('replace existing dependencies', function() {
                ...
                it('should handle a single array of string argument',
                    function() {
                        should(testModule.dependencies).be.empty();
        ...
        describe('#addDependencies()', function() {
            ...
            it(
                'should accept a mix of multiple string and array of string arguments',
                function() {
                    should(function() {
                        testModule.addDependencies('logger', [
                                'logger'
            ...
            it('should not accept an array of non-string argument', function() {
                ...
                should(function() {
                    testModule.addDependencies(stringArray,
                        mixArray);
                }).throw(errors.ERR_MOD_005);
            });
            ...
            describe('merge arguments with existing dependencies', function() {
                ...
                it(
                    'should handle a mix of string and array of string argument',
                    function() {
                        testModule.addDependencies('db', ['server'],
                            'utils', ['socket', 'server']);
        ...
        describe('#setup()', function() {
            ...
            it(
                'should have a callback as 4th argument passing a null error by default',
                function(done) {
            ...
            it('should be overridable', function(done) {
                testModule.setup = function(app, options, imports,
                    donecb) {
                    donecb(null,
                        `The id of the module is ${this.id}`);
                };

                testModule.setup(null, null, null, function(err,
                    message) {
                    if (message ===
                        'The id of the module is myModule') {
                        done();
                    } else {
                        done(new Error(
                            'function setup not overriden'
                        ));
                    }
                });
            });
        ...
        describe('#enable()', function() {
            ...
            it('should be overridable', function(done) {
                ...
                testModule.enable(null, null, null, function(err,
                    message) {
                    if (message ===
                        'The id of the module is myModule') {
                        done();
        ...
        describe('#disable()', function() {
            ...
            it('should be overridable', function(done) {
                ...
                testModule.disable(null, null, null, function(err,
                    message) {
                    if (message ===
                        'The id of the module is myModule') {
                        done();
                            ...
                            'function disable not overriden'
                        ));
                    }
                });
            });
        ...
        describe('#destroy()', function() {
            ...
            it('should be overridable', function(done) {
                ...
                testModule.destroy(null, null, null, function(err,
                    message) {
                    if (message ===
                        'The id of the module is myModule') {
                        done();
                            ...
                            'function destroy not overriden'
                        ));
                    }
                });
            });
        ...
        describe('custom properties and methods', function() {
            ...
            it('should allow custom methods', function() {
                ...
                should(testModule.turnOff('01')).be.exactly(
                    '01 turned off');
            });
